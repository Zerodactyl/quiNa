...
object YouDaoTranslator : Translator {
    ...
    override suspend fun doTranslate(from: String, to: String, query: String): String {
        val target = if (to == "zh" || to.startsWith("zh")) "zh-CHS" else to
        if (target !in targetLanguages) {
    ...
    private fun request(param: String): String {
        ...
        val httpConnectionStream: InputStream = if (httpConnection.responseCode != HttpURLConnection.HTTP_OK) {
