...
public final class MainTabsHelper {
    ...
    public static int getMainTabsHeight() { return MAIN_TABS_HEIGHT; }
    public static int getMainTabsMargin() { return MAIN_TABS_MARGIN; }
    public static int getMainTabsHeightWithMargins() { return getMainTabsHeight() + getMainTabsMargin() * 2; }

    public static boolean isContactsTabHidden() { return getContactsPosition() < 0; }

    public static int getChatsPosition() { return getTabPosition(MainTabsConfigManager.TabType.CHATS, 0); }
    public static int getContactsPosition() { return getTabPosition(MainTabsConfigManager.TabType.CONTACTS, -1); }
    ...
    public static int getCallsOrSettingsPosition() {
        ...
        if (settingsPosition >= 0) return settingsPosition;
    ...
    public static int getBottomBarDisplayMode() { return NaConfig.INSTANCE.getMainTabsDisplayMode().Int(); }
    public static void setBottomBarDisplayMode(int mode) { NaConfig.INSTANCE.getMainTabsDisplayMode().setConfigInt(mode); }
