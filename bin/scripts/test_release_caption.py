...
class ReleaseCaptionTest(unittest.TestCase):
    def test_renders_conventional_commit_with_link_and_escaping(self):
        ...
        self.assertIn(
            "🧪 <b>quiNa</b> <code>12.9.0</code> <i>(1241)</i> · <b>Test Version</b>",
            caption,
        )
    ...
    def test_reads_actual_quina_version_from_apk_filename(self):
        path = Path("quiNa-v12.9.0(1241)-arm64-v8a.apk")
